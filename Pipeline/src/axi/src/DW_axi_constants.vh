...
`define ACT_ID_BUF_POINTER_W_AW_M1 32


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M1 3
...
`define ACT_ID_BUF_POINTER_W_AW_M2 32


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M2 3
...
`define ACT_ID_BUF_POINTER_W_AW_M3 16


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M3 2
...
`define ACT_ID_BUF_POINTER_W_AW_M4 16


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M4 2
...
`define ACT_ID_BUF_POINTER_W_AW_M5 16


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M5 2
...
`define ACT_ID_BUF_POINTER_W_AW_M6 16


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M6 2
...
`define ACT_ID_BUF_POINTER_W_AW_M7 16


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M7 2
...
`define ACT_ID_BUF_POINTER_W_AW_M8 16


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M8 2
...
`define ACT_ID_BUF_POINTER_W_AW_M9 16


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M9 2
...
`define ACT_ID_BUF_POINTER_W_AW_M10 16


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M10 2
...
`define ACT_ID_BUF_POINTER_W_AW_M11 16


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M11 2
...
`define ACT_ID_BUF_POINTER_W_AW_M12 16


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M12 2
...
`define ACT_ID_BUF_POINTER_W_AW_M13 16


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M13 2
...
`define ACT_ID_BUF_POINTER_W_AW_M14 16


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M14 2
...
`define ACT_ID_BUF_POINTER_W_AW_M15 16


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M15 2
...
`define ACT_ID_BUF_POINTER_W_AW_M16 16


`define LOG2_ACT_ID_BUF_POINTER_W_AW_M16 2
