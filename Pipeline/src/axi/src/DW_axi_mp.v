...
//----------------------------------------------------------------------
  ...
  localparam LCL_AR_PYLD_W = `AXI_AR_PYLD_M_W;
  localparam LCL_AW_PYLD_W = `AXI_AW_PYLD_M_W;
  localparam LCL_W_PYLD_W  = `AXI_W_PYLD_M_W;

  localparam LCL_R_M_PYLD_W = `AXI_R_PYLD_M_W;
  localparam LCL_R_S_PYLD_W = `AXI_R_PYLD_M_W;

  localparam LCL_B_M_PYLD_W = `AXI_B_PYLD_M_W;
  localparam LCL_B_S_PYLD_W = `AXI_B_PYLD_M_W;

  localparam ID_W = `AXI_MIDW;
